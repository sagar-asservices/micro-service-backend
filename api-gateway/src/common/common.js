export const _success = ({ code, message, data, res, extra }) => {
...
export const _error = ({ code, message, res, extra, error, method = null }) => {
  let errResp = {
    code: code,
    error: {
      message: message,
...
export const _checkFields = function (body, required, skip = []) {
...
export const _validateEmail = function (email) {
  var re =
